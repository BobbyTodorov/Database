...
CREATE FUNCTION GET_INFO_REC(M_REC_ID INT)
RETURNS TABLE(rec_name VARCHAR(128), phone_num INT)
RETURN SELECT REC_NAME, PHONE_NUM
       FROM RECEIPTIONIST
       WHERE M_REC_ID = REC_ID;

--test calling the function
SELECT *
FROM TABLE(FN45421.GET_INFO_REC(7123)) T;
